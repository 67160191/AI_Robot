...
function searchVocab(message) {
  ...
  const allDeviceAliases = {
    ...
    "ปั๊ม 1": "pump1", "ปั้ม 1": "pump1", "ปั๊ม1": "pump1", "ปั้ม1": "pump1", "ปั๊ม": "pump1", "ปั้ม": "pump1",
    ...
    "ปั๊มลม": "compressor1", "ปั้มลม": "compressor1",
    ...
    "compressor 1": "compressor1", "compressor1": "compressor1", "compressor": "compressor1", "air compressor": "compressor1",
    ...
    "robot 1": "robot1", "robot1": "robot1", "robot": "robot1", "r1": "robot1", "robot arm": "robot1",
    ...
    "heater 1": "heater1", "heater1": "heater1", "heater": "heater1", "oven heater": "heater1",
    ...
    "ไฟสัญญาณเตือน": "light1", "ไฟสัญญาณ": "light1", "ไฟเตือน 1": "light1", "ไฟเตือน1": "light1", "ไฟเตือน": "light1",
    "ไฟอลาร์ม": "light1", "ไฟเตือนภัย": "light1", "ไฟ tower": "light1", "tower light": "light1",
    "light 1": "light1", "light1": "light1", "light": "light1",

    // Chiller 1 (chiller1)
    "เครื่องทำความเย็น 1": "chiller1", "เครื่องทำความเย็น1": "chiller1", "เครื่องทำความเย็น": "chiller1",
    "ชิลเลอร์ 1": "chiller1", "ชิลเลอร์1": "chiller1", "ชิลเลอร์": "chiller1", "ชิลเล่อร์": "chiller1", "ชิลเลอร": "chiller1",
    "chiller 1": "chiller1", "chiller1": "chiller1", "chiller": "chiller1", "chiller unit": "chiller1",
  ...
  const allActionAliases = {
    ...
    "estop": "emergency_stop", "e-stop": "emergency_stop", "หยุดด่วน": "emergency_stop", "อันตราย": "emergency_stop",

    // Reset
    "รีเซ็ต": "reset", "รีเซต": "reset", "reset": "reset", "เริ่มต้นใหม่": "reset", "เริ่มใหม่": "reset", "ค่าเริ่มต้น": "reset", "ล้างค่า": "reset",
    ...
    "ตั้ง": "set_speed", "ปรับ": "set_speed", "เร่ง": "set_speed", "ลด": "set_speed", "เพิ่ม": "set_speed", "ยก": "set_speed", "หมุน": "set_speed",

    // Stop
    "หยุดเดิน": "stop", "หยุดทำงาน": "stop", "ดับเครื่อง": "stop", "ปิดเครื่อง": "stop", "หยุด": "stop", "stop": "stop", "off": "stop",
    "ปิด": "stop", "ดับ": "stop", "พัก": "stop", "พักเครื่อง": "stop", "ยกเลิก": "stop", "ปิดระบบ": "stop",
  ...
  const speedVal = allNums.length > 0 ? allNums[allNums.length - 1] : null;
